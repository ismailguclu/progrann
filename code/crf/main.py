...
def train_model(X_train, y_train, k=3, n_iter=50):
   ...
   print("Best f1-score: ", rs.scorer_)

   with open("final_crf_model.pkl", "wb") as f:
      pickle.dump(crf, f)

   return crf

def test_model(crf, X_test, y_test, labels):
   labels.remove("O")
...
if __name__ == "__main__":
   train_data, labels = get_data(TRAIN, TRAIN_PATH)
   test_data, _ = get_data(TEST, TEST_PATH)
